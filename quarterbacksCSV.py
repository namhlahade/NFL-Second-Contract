...
names = ["Aaron Rodgers", "Tom Brady", "Patrick Mahomes", "Deshaun Watson", "Russell Wilson", "Lamar Jackson", "Ryan Tannehill", "Justin Herbert", "Kyler Murray", "Baker Mayfield", "Derek Carr","Matthew Stafford", "Matt Ryan", "Kirk Cousins", "Dak Prescott", "Philip Rivers", "Joe Burrow", "Drew Brees", "Ben Roethlisberger", "Ryan Fitzpatrick", "Jared Goff", "Jalen Hurts", "Daniel Jones", "Andy Dalton", "Drew Brees", "Alex Smith", "Tua Tagovailoa", "Teddy Bridgewater", "Jimmy Garoppolo", "Mitchell Trubisky", "Cam Newton", "Drew Lock", "Gardner Minshew", "Carson Wentz", "Sam Darnold", "Taylor Heinicke", "Josh Allen"]
...
with open('/Users/namhlahade/Documents/GitHub/NFL-Second-Contract/quarterbackStats.csv', 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
    ...
    for quarterback in names:
        ...
        if quarterbackRaw == "Josh Allen":
            quarterbackURL = "https://www.nfl.com/players/josh-allen-4/stats/logs/2020/"
